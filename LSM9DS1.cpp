...
void LSM9DS1Class::setGyroscopeSettings(int outputDataRate, int fullScale, int bandWidth) {
  _gyroscopeSettings.hex = outputDataRate | fullScale | bandWidth;

  switch (outputDataRate) {
    case LSM9DS1_ODR_G_POWERDOWN:
      _gyroscopeSettings.ODR = 0.0f;
      break;
    case LSM9DS1_ODR_G_15HZ:
      _gyroscopeSettings.ODR = 14.9f;
      break;
    case LSM9DS1_ODR_G_60HZ:
      _gyroscopeSettings.ODR = 59.5f;
      break;
    case LSM9DS1_ODR_G_119HZ:
      _gyroscopeSettings.ODR = 119.0f;
      break;
    case LSM9DS1_ODR_G_238HZ:
      _gyroscopeSettings.ODR = 238.0f;
      break;
    case LSM9DS1_ODR_G_476HZ:
      _gyroscopeSettings.ODR = 476.0f;
      break;
    case LSM9DS1_ODR_G_952HZ:
      _gyroscopeSettings.ODR = 952.0f;
      break;
  }

  switch (fullScale) {
    case LSM9DS1_FS_G_245DPS:
      _gyroscopeSettings.FS = 245.0f;
      break;
    case LSM9DS1_FS_G_500DPS:
      _gyroscopeSettings.FS = 500.0f;
      break;
    case LSM9DS1_FS_G_2000DPS:
      _gyroscopeSettings.FS = 2000.0f;
      break;
  }

  _gyroscopeSettings.BW = bandWidth;
}

void LSM9DS1Class::setAccelerometerSettings(int outputDataRate, int fullScale, int bandWidthSelect, int bandWidth) {
  _accelerometerSettings.hex = outputDataRate | fullScale | bandWidthSelect | bandWidth;

  switch (outputDataRate) {
    case LSM9DS1_ODR_XL_POWERDOWN:
      _accelerometerSettings.ODR = 0.0f;
      break;
    case LSM9DS1_ODR_XL_10HZ:
      _accelerometerSettings.ODR = 10.0f;
      break;
    case LSM9DS1_ODR_XL_50HZ:
      _accelerometerSettings.ODR = 50.0f;
      break;
    case LSM9DS1_ODR_XL_119HZ:
      _accelerometerSettings.ODR = 119.0f;
      break;
    case LSM9DS1_ODR_XL_238HZ:
      _accelerometerSettings.ODR = 238.0f;
      break;
    case LSM9DS1_ODR_XL_476HZ:
      _accelerometerSettings.ODR = 476.0f;
      break;
    case LSM9DS1_ODR_XL_952HZ:
      _accelerometerSettings.ODR = 952.0f;
      break;
  }

  switch (fullScale) {
    case LSM9DS1_FS_XL_2G:
      _accelerometerSettings.FS = 2.0f;
      break;
    case LSM9DS1_FS_XL_4G:
      _accelerometerSettings.FS = 4.0f;
      break;
    case LSM9DS1_FS_XL_8G:
      _accelerometerSettings.FS = 8.0f;
      break;
    case LSM9DS1_FS_XL_16G:
      _accelerometerSettings.FS = 16.0f;
      break;
  }

  _accelerometerSettings.BW_SCAL = bandWidthSelect;
  _accelerometerSettings.BW = bandWidth;
...
int LSM9DS1Class::begin()
{
  ...
  writeRegister( LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, _gyroscopeSettings.hex ); 
  writeRegister( LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG6_XL, _accelerometerSettings.hex ); 
...
int LSM9DS1Class::readAcceleration(float& x, float& y, float& z)
{
  ...
  x = data[0] * _accelerometerSettings.FS / 32768.0;
  y = data[1] * _accelerometerSettings.FS / 32768.0;
  z = data[2] * _accelerometerSettings.FS / 32768.0;
...
int LSM9DS1Class::readGyroscope(float& x, float& y, float& z)
{
  ...
  x = data[0] * _gyroscopeSettings.FS / 32768.0;
  y = data[1] * _gyroscopeSettings.FS / 32768.0;
  z = data[2] * _gyroscopeSettings.FS / 32768.0;
